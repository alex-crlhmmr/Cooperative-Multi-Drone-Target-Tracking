"""V5 Config — FIM-based spread reward, heuristic tracking for eval."""
...
class V5Config:
    ...
    save_path: str = "./output/v5"
    normalize_obs: bool = True
    normalize_value_targets: bool = True

    # ── Early termination (eval tracking) ──
