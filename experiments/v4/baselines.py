"""V4 Baselines — heuristic controllers for comparison."""
...
def run_heuristic_twophase(env_spread, env_track, cfg: V4Config,
...
def run_baseline_no_spread(env_track, cfg: V4Config, total_steps: int = 5000):
...
def run_rl_twophase(
    spread_actor, track_actor, env_spread, env_track, cfg: V4Config,
