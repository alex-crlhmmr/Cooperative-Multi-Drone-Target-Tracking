"""V5 Phase 2: TrackEnv — used for eval only (chase+offset tracking).

Identical to V4 TrackEnv but imports V5Config.
"""
...
class TrackEnv(gym.Env):
    ...
    Used in V5 eval only — tracking is done by heuristic chase+offset (zero action).
    """
    ...
    def __init__(self, cfg: V5Config, seed: int | None = None,
        ...
        self.actor_obs_dim = cfg.track_actor_obs_dim
