"""V4 Replay — run single episode for any scenario and animate."""
...
def main():
    parser = argparse.ArgumentParser(description="V4 Replay Animation")
    ...
    if args.scenario == "baseline":
        ...
        print("Running V4 RL (spread → track)...")
