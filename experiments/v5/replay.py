"""V5 Replay — run single episode for any scenario and animate."""
...
def main():
    parser = argparse.ArgumentParser(description="V5 Replay Animation")
    ...
    parser.add_argument("--spread-ckpt", type=str, default=None,
                        help="Spread checkpoint (for rl scenario)")
    ...
    if args.scenario == "baseline":
        ...
        if not args.spread_ckpt:
            print("ERROR: --spread-ckpt required for rl scenario")
            return

        print("Running V5 RL spread -> chase+offset...")
        ...
        result = run_rl_spread_heuristic_track(
