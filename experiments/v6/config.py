"""V6 Config — Angular-repulsion tracking with RL residual."""
...
class V6Config:
    ...
    spread_surround_weight: float = 0.3
    ...
    # ── Angular repulsion (V6 key params) ──
    angular_weight: float = 0.3
